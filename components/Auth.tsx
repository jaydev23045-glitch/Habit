    ...
    <div className="min-h-screen bg-bgDark flex flex-col items-center justify-center p-4 sm:p-6 font-sans">
      <div className={`w-full max-w-md transition-all duration-300 ${shake ? 'animate-[shake_0.5s_ease-in-out]' : 'animate-fade-in'}`}>
        ...
        <div className="mt-6 text-center">
          <div className="inline-flex items-center justify-center gap-2 text-slate-600">
             <ShieldCheck size={16} /> 
             <span className="text-[9px] font-bold uppercase tracking-widest text-slate-500">Local-First Vault Verification</span>
          </div>
        </div>
      </div>
    </div>
